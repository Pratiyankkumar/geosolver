...
class GeometricFigure(Scene):
    def construct(self):
        ...
        points_data = {
            0: (672.9720930232559, 404.4925),
            1: (0.5591397849462366, 404.3333333333333),
            2: (674.2416942422236, 1.8520668940589542),
            3: (872.5037037037036, 404.3333333333333),
            4: (831.1904971403432, 319.4351077870656)
        }
