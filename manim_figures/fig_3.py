...
class GeometricFigure(Scene):
    def construct(self):
        ...
        points_data = {
            0: (106.43991752075212, 204.02516636369677),
            1: (110.54434828503172, 80.5791919697346),
            2: (10.619136785130383, 83.04984327937936),
            3: (-183.13844515442042, -166.07454739084233),
            4: (256.39401719226987, 202.66358840735208),
            5: (0.0, 205.0),
            6: (16.958522727272726, 1.136742424242423)
        }
        ...
        all_objects = VGroup(*line_objects, *point_dots.values(), *point_labels.values())
        
        # Apply 180-degree rotation
        all_objects.rotate(PI)
        
        # Apply inversion (reflection across both axes)
        all_objects.scale(-1)
